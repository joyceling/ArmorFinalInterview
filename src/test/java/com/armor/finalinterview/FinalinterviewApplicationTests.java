...
public class FinalinterviewApplicationTests {
    ...
    public void LocalDateConverterShouldConvertType() {
        ...
        // null
        assertEquals(null, localDateTimeAttributeConverter.convertToEntityAttribute(null), "Timestamp should be converted to LocalDateTime");
        assertEquals(null, localDateTimeAttributeConverter.convertToDatabaseColumn(null), "Timestamp should be converted to LocalDateTime");
    ...
    public void priorityShouldChangeHours() {
        ...
        // assert statements
        assertEquals(0, priorityHoursPolicy.convertPriorityToHours(null), "High priority must be 4");
